...
def generate_job_insights():
    ...
    try:
        ...
        try:
            ...
            print(f"Could not enhance job insights with PDF facts: {e}")
        ...
        try:
            ...
            try:
                ...
                if user_pdfs:
                    ...
                    print("ℹNo PDFs found for enhancement")
            except Exception as e:
                print(f"Could not enhance insights with PDF facts: {e}")
...
def generate_podcast_on_demand():
    ...
    try:
        ...
        print(f"Generating podcast on-demand for: {card_heading}")
        ...
        if not backside_insights:
            ...
            try:
                ...
                if user_pdfs:
                    ...
                    print("ℹNo PDFs found for podcast enhancement")
            except Exception as e:
                print(f"Could not enhance insights with PDF facts: {e}")
                # Continue with base insights if enhancement fails
