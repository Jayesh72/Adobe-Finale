...
def generate_card_insights(frontside_heading, content=""):
    ...
    try:
        ...
        print(f"Using fallback content for {frontside_heading}")
        return {
    ...
    try:
        ...
        if content and len(content.strip()) > 50:  # Only if we have substantial content
            ...
            if meaningful_insights >= 4:  # At least 4 meaningful insights
                ...
                print(f"Only {meaningful_insights} meaningful insights found in content, falling back to intelligent generation")
...
def search_pdfs_for_facts(topic, user_id, pdf_ids=None):
    ...
    try:
        ...
        print("PDF search functionality not yet implemented")
        return []
...
def enhance_insights_with_pdf_facts(insights, topic, user_id, pdf_ids=None):
    ...
    try:
        ...
        if pdf_facts:
            ...
            print("No additional PDF facts found, using existing insights")
            return insights
